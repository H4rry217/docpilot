...
/**
 * Verifies DocPilot bearer JWTs without depending on Servlet APIs.
 */
public class JwtTokenVerifier {

    private final DocPilotJwtConfig config;

    public JwtTokenVerifier(DocPilotJwtConfig config) {
        this.config = config;
    }

    public Optional<AuthSubject> verify(String token) {
