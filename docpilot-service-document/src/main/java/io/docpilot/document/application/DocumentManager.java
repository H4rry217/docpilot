...
public class DocumentManager {
    ...
    public DocumentManager(DocumentRepository documentRepository,
        ...
        this(documentRepository, authContextProvider, accessAuthorizer, userProfileProvider,
    ...
    /**
     * Reads a document and enriches it with owner profile data when available.
     */
    public DocumentDetail getDocumentDetail(String documentId) {
        DocPilotDocument document = getDocument(documentId);
        DocumentDetail detail = new DocumentDetail();
        detail.setDocument(document);
        detail.setOwnerProfile(userProfileProvider.findByUserId(document.getOwnerUserId()).orElse(null));
        return detail;
    }
